...
var photoSchema = new mongoose.Schema({
    ...
    mentions: [mongoose.Schema.Types.ObjectId], //Array of id's for mentioned users
    permissions: [mongoose.Schema.Types.ObjectId] //Array of user_id's for whom can view this photo.
});
